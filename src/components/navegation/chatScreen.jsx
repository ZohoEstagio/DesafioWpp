...
export default function Chat() {
	return (
		<div className=" flex flex-col w-[50%] h-full items-start ">
			<InfoAvatar />
			<div className=" w-full h-full">
				...
				<div className="absolute bottom-0 w-[50%] flex justify-center items-center p-4">
					<div className="pl-4 pr-4 pt-4 w-full flex flex-row gap-4 items-center justify-center">
